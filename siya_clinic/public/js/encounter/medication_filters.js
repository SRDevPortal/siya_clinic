// siya_clinic/public/js/encounter/medication_filters.js

console.log("Medication Filters JS file loaded");

const CLASS_FILTERS = {
	drug_prescription: ["Ayurvedic", "Ayurvedic Medicine"], // allow both labels if you use variants
	sr_homeopathy_drug_prescription: ["Homeopathic", "Homeopathic Medicine"],
	sr_allopathy_drug_prescription: ["Allopathic", "Allopathic Medicine"],
};
